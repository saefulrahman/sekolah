        ...
        <div class="content container">
            <div class="page-wrapper">
                <header class="page-heading clearfix">
                    <h1 class="heading-title pull-left">All Events</h1>
                    <div class="breadcrumbs pull-right">
                        <ul class="breadcrumbs-list">
                            <li class="breadcrumbs-label">You are here:</li>
                            <li><a href="index-2.html">Home</a><i class="fa fa-angle-right"></i></li>
                            <li class="breadcrumbs-label">All Events</li>
                        </ul>
                    </div><!--//breadcrumbs-->
                </header>
                <div class="page-content">
                    <div class="row page-row">
                        <div class="events-wrapper col-md-8 col-sm-7">
                            ...
                            $list_events = mysqli_query($link, "select * from kegiatan limit $posisi, $batas");
                            while($data = mysqli_fetch_array($list_events)){
                                ?>
                                <article class="events-item page-row has-divider clearfix">
                                    ...
                                    <div class="details col-md-11 col-sm-10">
                                        <h3 class="title"><?= $data[5]; ?></h3>
                                        <p class="meta"><span class="time"><i class="fa fa-clock-o"></i><?= $data[4]; ?></span><span class="location"><i class="fa fa-map-marker"></i><?= $data[6]; ?></span></p>
                                    </div>
                                </article>
                                <?php
                            }
                        ...
                        <aside class="page-sidebar  col-md-3 col-md-offset-1 col-sm-4 col-sm-offset-1">
                            <section class="widget has-divider">
                                ...
                                <?php
                                $list_news = mysqli_query($link, "select * from kabar_terkini limit 7");
                                while($data = mysqli_fetch_array($list_news)){
                                    ...
                                    <article class="news-item row">
                                        <figure class="thumb col-md-2">
                                            <img src="dashboard/img/news/<?= $data[3] ?>" alt="Foto Berita" >
                                        </figure>
                                        <div class="details col-md-10">
                                            <h4 class="title"><a href="news.php?page=<?= abs((int) $data[0]) ?>&lastest_news=<?= $direct ?>"><?= $data[1] ?></a></h4>
                                        </div>
                                    </article>
                                    <?php
                                }
