      ...
      <nav class="main-nav" role="navigation">
        ...
        <div class="content container">
            <div class="page-wrapper">
                ...
                $direct = sha1(sha1($list).sha1('Sq1-Inj3Ct10N'));

                if($page == $direct){
                    $full = mysqli_query($link, "select G.* , K.* from gallery G JOIN kegiatan K USING (id_kegiatan) WHERE G.id_kegiatan='$list' AND G.id_kegiatan=K.id_kegiatan");
                    $row = mysqli_fetch_array($full);
                    ?>
                    <header class="page-heading clearfix">
                        <h1 class="heading-title pull-left">Album <?= $row['judul'] ?> </h1>
                        <div class="breadcrumbs pull-right">
                            <ul class="breadcrumbs-list">
                                <li class="breadcrumbs-label">You are here:</li>
                                <li><a href="index.php">Home</a><i class="fa fa-angle-right"></i></li>
                                <li><a href="gallery.php">Gallery</a><i class="fa fa-angle-right"></i></li>
                                <li class="breadcrumbs-label">Album <?= $row['judul'] ?></li>
                            </ul>
                        </div><!--//breadcrumbs-->
                    </header>
                    <div class="page-content">
                        ...
                        while($data = mysqli_fetch_array($full)){
                            ?>
                            <a class="prettyphoto col-md-3 col-sm-3 col-xs-6" rel="prettyPhoto[gallery]" title="Kegiatan <?= $data['judul'] ?>" href="dashboard/img/gallery/<?= $data['foto'] ?>"><img class="img-responsive img-thumbnail" src="dashboard/img/gallery/<?= $data['foto'] ?>" alt="" /></a>
                            <?php
                        }
                        ?>
                        </div>
