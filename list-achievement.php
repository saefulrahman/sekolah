                ...
                <div class="page-content">
                    <div class="row page-row">
                        <div class="news-wrapper col-md-8 col-sm-7">
                            ...
                            $list = mysqli_query($link, "select * from achievement limit $posisi, $batas");
                            while($data = mysqli_fetch_array($list)){
                                $direct = sha1(sha1($data[0]).sha1('Sq1-Inj3Ct10N'));
                                ?>
                                <article class="news-item page-row has-divider clearfix row">
                                    <figure class="thumb col-md-2 col-sm-3 col-xs-4">
                                        <img class="img-responsive" src="dashboard/img/achievement/<?= $data['photo'] ?>" alt="" />
                                    </figure>
                                    <div class="details col-md-10 col-sm-9 col-xs-8">
                                        <h3 class="title"><a href="news-single.html"><?= $data['title'] ?></a></h3>
